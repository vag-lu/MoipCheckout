...
var _buyerinfo_comp = require("./componentes/buyerinfo_comp.js");

var _buyerinfo_comp2 = _interopRequireDefault(_buyerinfo_comp);
...
var App = function () {
    function App(body) {
        ...
        this.buyerinfo = new _buyerinfo_comp2.default(body);
    }
    ...
    _createClass(App, [{
        ...
        key: "buyerInfoEvents",
        value: function buyerInfoEvents() {
            this.buyerinfo.on("error", function (error) {
                return alert(error);
            });
            this.buyerinfo.on("submit", function (res) {
...
},{"./componentes/buyerinfo_comp.js":5}],4:[function(require,module,exports){
"use strict";
...
var Checkout = function (_TinyEmitter) {
    _inherits(Checkout, _TinyEmitter);
...
var _buyerInfo = require("../templates/buyerInfo.js");

var _buyerInfo2 = _interopRequireDefault(_buyerInfo);
...
var BuyerInfo = function (_Checkout) {
    _inherits(BuyerInfo, _Checkout);

    function BuyerInfo(body) {
        _classCallCheck(this, BuyerInfo);

        var _this = _possibleConstructorReturn(this, (BuyerInfo.__proto__ || Object.getPrototypeOf(BuyerInfo)).call(this));
    ...
    _createClass(BuyerInfo, [{
        ...
        value: function render() {
            this.body.innerHTML = _buyerInfo2.default.render();
        ...
        value: function formSubmit() {
            ...
            form.addEventListener("submit", function (e) {
                e.preventDefault();
                var buyer_name = e.target.querySelector("[data-name]");
                var buyer_email = e.target.querySelector("[data-email]");
                var buyer_cpf = e.target.querySelector("[data-cpf]");
                var amount = e.target.querySelector("[data-amount]");
                var radio_cc = e.target.querySelector("[radio-cc]");
                var opts = void 0;
                if (radio_cc.checked) {
                    var card_number = e.target.querySelector("[data-cc-number]");
                    var card_holder = e.target.querySelector("[data-holder-name]");
                    var cvv = e.target.querySelector("[data-cvv]");
                    var exp_date = e.target.querySelector("[data-exp-date]");
                    opts = {
                        method: "POST",
                        url: _this2.URL + "/creditcard",
                        json: true,
                        body: {
                            client_id: client_id,
                            amount: amount.value,
...
},{"../checkout.js":4,"../templates/buyerInfo.js":6}],6:[function(require,module,exports){
"use strict";
